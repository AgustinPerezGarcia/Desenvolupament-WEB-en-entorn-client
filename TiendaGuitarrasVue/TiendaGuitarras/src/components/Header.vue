...
import { computed } from 'vue';
    ...
    const emit = defineEmits(['reducir-cantidad', 'aumentar-cantidad', 'borrar-guitarra', 'borrar-carrito', 'agregar-carrito'])
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                <table class="w-100 table">
                                    ...
                                    <tbody>
                                        <tr v-for="producto in carrito">
                                            <td>
                                                <img class="img-fluid" 
                                                v-bind:src="`/img/${producto.imagen}.jpg`" alt="imagen guitarra">
                                            </td>
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @:click="$emit('cambiar-cantidad',producto, 0)"
                                                >
                                                    -
                                                </button>
                                                    {{ producto.cantidad }}
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @:click="$emit('cambiar-cantidad',producto, 1)"
                                                >
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    ...
                                                    type="button"
                                                    @:click="$emit('borrar-guitarra',producto)"
                                                >
                                                    X
                                                </button>
                                            </td>
                                ...
                                <p class="text-end">Total pagar: <span class="fw-bold">{{ precioTotal }}€</span></p>
                                <button class="btn btn-dark w-100 mt-3 p-2" 
                                @:click="$emit('borrar-carrito')">
                                Vaciar Carrito
                                </button>
                            </div>
                        </div>
